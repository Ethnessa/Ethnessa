...
public class GroupCommand : Command
{
	...
	public override List<string> Permissions { get; protected set; } = new(){EthnessaAPI.Permissions.managegroup};
	...
	public static void Execute(CommandArgs args)
	{
		...
		switch (subCmd)
		{
...

			{
				...
				try
				{
					GroupManager.AddGroup(groupName, null, permissions, Group.DefaultChatColor);
