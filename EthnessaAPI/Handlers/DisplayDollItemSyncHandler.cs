...
namespace EthnessaAPI.Handlers
{
	...
	/// </summary>
	public class DisplayDollItemSyncHandler : IPacketHandler<GetDataHandlers.DisplayDollItemSyncEventArgs>
	{
		public void OnReceive(object sender, GetDataHandlers.DisplayDollItemSyncEventArgs args)
		{
